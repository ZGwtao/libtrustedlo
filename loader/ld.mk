...
TSLDR_LD_PANCAKE_OBJS := $(PANCAKE_SELF_LOAD_OBJ)

TSLDR_LD_OBJS := $(LIB_BUILD_DIR)/loader.o
MISC_OBJS := $(LIB_BUILD_DIR)/memory.o
...
$(TSLDR_LD_ELF): \
    $(TSLDR_LD_OBJS) $(TSLDR_LD_PANCAKE_OBJS) $(MISC_OBJS) $(TSLDR_LD_LINKER_SCRIPT) \
	$(VM_LAYOUT_LINKER_SCRIPT) \
	$(LIBTRUSTEDLO)
	$(LD) $(TSLDR_LD_LDFLAGS) \
	    $(TSLDR_LD_OBJS) \
	    $(TSLDR_LD_PANCAKE_OBJS) \
	    $(MISC_OBJS) \
	    $(LIBTRUSTEDLO) \
	    -lmicrokit \
	    -o $@
